...
if "${BUCKET_EXISTS}"; then
  ...
  gcloud storage buckets create gs://x391-poc-project-vpc-vigenair --project=x391-poc-project-vpc --location=europe-west1 --uniform-bucket-level-access
  test $? -eq 0 || exit
  printf "\nINFO - Bucket 'x391-poc-project-vpc-vigenair' created successfully in location 'europe-west1'!\n"
fi
